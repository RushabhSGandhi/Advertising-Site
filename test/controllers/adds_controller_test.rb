...
class AddsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create add" do
    assert_difference('Add.count') do
      post adds_url, params: { add: { description: @add.description, images: @add.images, is_published: @add.is_published, title: @add.title } }
    end
  ...
  test "should update add" do
    patch add_url(@add), params: { add: { description: @add.description, images: @add.images, is_published: @add.is_published, title: @add.title } }
